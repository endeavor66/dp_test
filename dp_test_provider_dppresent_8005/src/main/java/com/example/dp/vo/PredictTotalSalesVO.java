...
import com.example.dp.po.PredictTotalSales;
...
public class PredictTotalSalesVO {
    ...
    public PredictTotalSalesVO() {
    }

    public PredictTotalSalesVO(String id, String shop_id, Date date, double result, double actual) {
        this.id = id;
