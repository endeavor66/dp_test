...
import com.example.dp.po.RecommendResult;
...
public class RecommendResultVO {
    ...
    public RecommendResultVO(String id, String shop_id, Date recommand_date, String product_id, double weight, String reason) {
        this.id = id;
