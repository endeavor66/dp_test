...
public class Store {
    ...
    public Store(String id, String shop_name, String shop_location, String shop_type, String shop_synopsis, Date found_date, String shop_director, int shop_capital){
        this.id = id;
        this.shop_name = shop_name;
        this.shop_location = shop_location;
        this.shop_type = shop_type;
